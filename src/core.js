    ...
    cls.BaseBuilder = class extends cls.Cloneable {
        ...
        _sanitizeValue(item) {
            ...
            if (null === item) {
                ...
                let typeIsValid = !!getValueHandler(
                    item,
        ...
        _formatCustomValue(value, asParam, formattingOptions) {
            ...
            let customHandler = getValueHandler(
                value,
                this.options.valueHandlers,
                cls.globalValueHandlers
            );
        ...
        _formatValueForParamArray(value, formattingOptions = {}) {
            if (_isArray(value)) {
                ...
                return this._formatCustomValue(value, true, formattingOptions)
                    .value;
            }
        }
        ...
        _buildManyStrings(strings, strValues, options = {}) {
            ...
            for (let idx = 0; strings.length > idx; ++idx) {
                ...
                let { text, values } = this._buildString(
                    inputString,
                    inputValues,
                    {
  ...
  */
    ...
    */
    ...
    cls.AbstractVerbSingleValueBlock = class extends cls.Block {
        ...
        _setValue(value) {
            this._value =
                null !== value ? this._sanitizeLimitOffset(value) : value;
        }
    ...
    */
        join(table, alias = null, condition = null, type = "INNER") {
            ...
            alias = alias ? this._sanitizeTableAlias(alias) : alias;
            condition = condition
                ? this._sanitizeExpression(condition)
                : condition;
